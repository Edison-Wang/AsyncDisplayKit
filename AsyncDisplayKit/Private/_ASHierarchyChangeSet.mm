...
- (_ASHierarchySectionChange *)changeByFinalizingType
{
  ...
  switch (_changeType) {
    ...
    case _ASHierarchyChangeTypeOriginalDelete:
      ...
      break;
    default:
      ASDisplayNodeFailAssert(@"Attempt to finalize section change of invalid type %@.", NSStringFromASHierarchyChangeType(_changeType));
      return self;
  }
...
- (_ASHierarchyItemChange *)changeByFinalizingType
{
  ...
  switch (_changeType) {
    ...
    case _ASHierarchyChangeTypeOriginalDelete:
      ...
      break;
    default:
      ASDisplayNodeFailAssert(@"Attempt to finalize item change of invalid type %@.", NSStringFromASHierarchyChangeType(_changeType));
      return self;
  }
